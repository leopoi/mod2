...
package net.mcreator.aaaaaaaaaaaaaaaaaa.world.structure;
...
public class StructureWatersheap extends ElementsAaaaaaaaaaaaaaaaaa.ModElement {
	public StructureWatersheap(ElementsAaaaaaaaaaaaaaaaaa instance) {
		super(instance, 13);
	}
		...
		if ((random.nextInt(1000000) + 1) <= 10000) {
			...
			for (int a = 0; a < count; a++) {
				...
				Template template = ((WorldServer) world).getStructureTemplateManager().getTemplate(world.getMinecraftServer(),
						new ResourceLocation("aaaaaaaaaaaaaaaaaa", "aaaaaaaaaaaaaaaaaaa"));
				if (template == null)
					return;
